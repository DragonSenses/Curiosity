...
So let's see more navigation links that only take *element nodes* into account: <img src="img/element-nodes.png">
...
The specification: <a href="https://html.spec.whatwg.org/multipage/tables.html">tabular data</a>.
