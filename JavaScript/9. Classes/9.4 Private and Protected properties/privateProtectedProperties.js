...
/* Private "#waterLimit" */
/* There's a finished JavaScript proposal, almost in the standard, that 
provides language-level support for private properties and methods.

Privates should start with #. They are only accessible from inside the class.

For instance, here's a private #waterLimit property and the water-checking 
private method #fixWaterAmount: */
{
  class CoffeeMachine {
    #waterLimit = 200;
...
private #waterAmount and public waterAmount fields at the same time.
...
to #waterAmount. We'll need to rely on waterAmount getter/setter: */
  ...
  console.log(megaMachine);
}
/* In many scenarios such limitation is too severe. If we extend a 
CoffeeMachine, we may have legitimate reasons to access its internals. 
That's why protected fields are used more often, even though they are not 
supported by the language syntax. */
